...
dataset=$1
exp_name=$2
# Capture any additional CLI flags (e.g., pruning or quantization options)
shift 2
other_args="$@"
...
$PYTHON tool/train_prune.py --config=${config} $other_args 2>&1 | tee ${model_dir}/train-$now.log
